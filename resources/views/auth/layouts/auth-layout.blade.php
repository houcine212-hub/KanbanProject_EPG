...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* ── الأزرار العمودية - أعمدة دائرية صغيرة ── */
        .hero-buttons {
            display: flex;
            flex-direction: column;
            align-items: center;
...
<body>
    <div class="auth-container" id="authContainer">
        ...
        <!-- الحالة الأولى: الصفحة الكاملة -->
        <div class="hero-content" id="heroContent">
            <img src="{{ asset('images/epg-logo.jpg') }}" alt="EPG" class="hero-logo">
            <div class="hero-title">EPG Kanban</div>
            <div class="hero-sub">منصة إدارة المهام الذكية</div>
            
            <!-- أزرار عمودية دائرية -->
            <div class="hero-buttons">
                <button class="btn-pill" onclick="showLogin()">
                    
                    تسجيل الدخول
                </button>
                <button class="btn-pill" onclick="showRegister()">
                    إنشاء حساب
                </button>
            </div>
        </div>

        <!-- الحالة الثانية: اللوحة الجانبية + النموذج -->
        ...
        <div class="form-panel" id="formPanel">
            <div class="form-card" id="formCard">
                <div class="back-btn" onclick="showHero()">
            ...
            formCard.innerHTML = `
                ...
                <form action="{{ route('login') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" placeholder="example@epg.ma" required autofocus>
                    </div>
                    <div class="form-group">
                ...
                <div class="link-row">
                    ليس لديك حساب؟ <a onclick="showRegister()">إنشاء حساب</a>
                </div>
            `;
        }
            ...
            formCard.innerHTML = `
                ...
                <form action="{{ route('register') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" placeholder="أدخل اسمك الكامل" required autofocus>
                    </div>
                    <div class="form-group">
                        <label>البريد الإلكتروني</label>
                        <input type="email" name="email" placeholder="example@epg.ma" required>
                    </div>
                    <div class="form-group">
                        <label>كلمة المرور</label>
                        <input type="password" name="password" placeholder="••••••••" required>
